...
P_levels = np.arange(1000, 150-50, -50)
theta_levels = (np.arange(-40, 100_10, 10)) + C_to_K
...
x_mixing_ratios = [x_from_Tp(Bolton.mixing_ratio_line(p_all,mixing_ratios_i),p_all) for mixing_ratios_i in mixing_ratios]
